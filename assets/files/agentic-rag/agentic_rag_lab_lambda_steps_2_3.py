...
Milestone: after Part 10 Steps 2 and 3.
...
This is the intermediate version without the Step 6 fallback behavior. For the
final version with graceful degradation, see agentic_rag_lab_lambda_step_6.py.
